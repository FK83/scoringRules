...
CRPS formula:
\begin{align*}
	\mathrm{CRPS}(F_{\sigma_1, \sigma_2}, y) &= \begin{cases}	\left\lvert \frac{y}{\sigma_1} \right\rvert + \frac{2\sigma_1}{\sigma_1 + \sigma_2}\exp\left(-\left\lvert \frac{y}{\sigma_1}\right\rvert \right) - \frac{ 2\sigma_1}{\sigma_1 + \sigma_2} + \frac{\sigma_1^2 + \sigma_2^2}{2(\sigma_1 + \sigma_2)^2}, & y < 0, \\ \left\lvert \frac{y}{\sigma_2}\right\rvert + \frac{2\sigma_2}{\sigma_1 + \sigma_2}\exp\left(-\left\lvert \frac{y}{\sigma_2}\right\rvert \right) - \frac{ 2\sigma_2}{\sigma_1 + \sigma_2} + \frac{\sigma_1^2 + \sigma_2^2}{2(\sigma_1 + \sigma_2)^2}, & y \ge 0, \end{cases} \\
...
CRPS formula:
	\[
	\mathrm{CRPS}(F_{\alpha,\beta},y) = y\Big(2F_{\alpha,\beta}(y)-1\Big) - \frac{\alpha}{\beta}\left(2F_{\alpha + 1, \beta}(y) -1\right) + \frac{\alpha}{B\left(\tfrac{1}{2},\alpha\right)}
	\]
Gamma distribution:
\begin{align*}
...
### Generalized continuous uniform
CRPS formula:
\begin{align*}
...
## Exponential distribution with point mass (`"exp"`) {#GenExp}
\begin{align*}
...
## Generalized truncated/censored logistic distribution (`"logis"`) {#GenLogistic}
CRPS formula:
\begin{align*}
...
## Generalized truncated/censored normal distribution (`"norm"`) {#GenNormal}
CRPS formula:
\begin{align*}
	\mathrm{CRPS}\left(F_{l, L}^{u, U}, y\right) &= |y - z| + uU^2 - lL^2 \\
...
## Generalized truncated/censored Student's $t$-distribution (`"t"`) {#GenStudent}
CRPS formula:
\begin{align*}
