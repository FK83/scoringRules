...
This vignette corresponds to an article of the same name which has been conditionally accepted for publication at the Journal of Statistical Software. While the two articles are close to identical at the time of this writing (July 27, 2018), the vignette may be updated to reflect future changes in the package. To cite the package, please use \cite{JordanEtAl2018}. 
