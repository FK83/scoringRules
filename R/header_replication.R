#' Run the case study in KLTG (2017), or a smaller version thereof
...
#' @details The full results in Section 5 of KLTG (2017) are based on the following setup: \code{burnin_size = 10000},
...
#' @references Krueger, F., S. Lerch, T.L. Thorarinsdottir and T. Gneiting (2017), `Probabilistic forecasting and comparative model assessment based on Markov Chain Monte Carlo output', working paper, Heidelberg Institute for Theoretical Studies, available at \url{http://arxiv.org/abs/1608.06802}.
...
#' @export
#' @details The plot is in the same format as Figure 5 in KLTG (2017). Its content (nr of MCMC chains, 
...
#' @details The full results in Section 4 of KLTG (2017) are based on \code{s = 2}, \code{a = 0.5},
...
#' @param ... Additional parameters, see details below. 
#' @return none, used for the effect of drawing a plot. 
#' @details The plot is in the same format as Figure 1 or 2 in KLTG (2017), depending on the 
...
#' 
#' Krueger, F., S. Lerch, T.L. Thorarinsdottir and T. Gneiting (2017), `Probabilistic forecasting and comparative model assessment based on Markov Chain Monte Carlo output', working paper, Heidelberg Institute for Theoretical Studies, available at \url{http://arxiv.org/abs/1608.06802}.
#' @seealso \link{run_casestudy} uses \link{ar_ms} to replicate the results of KLTG (2017, Section 5).
