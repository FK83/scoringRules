...
#' @keywords replication
#' @author Fabian Krueger
plot.casestudy <- function(casestudy, ...){
...
summary.casestudy <- function(casestudy){
  # Get output component
  x <- casestudy$output
...
#' @param mcstudy object of class \code{mcstudy}, generated by \link{run_mcstudy}
#' @param ... additional parameters, see details below. 
#' @return none, used for the effect of drawing a plot. 
